...
async function testEnrichmentMode() {
    console.log('🔄 Testing Owner Enrichment with --force Flag');
    ...
    try {
        ...
        console.log('\n📊 Test 1: Normal Mode (without --force)');
        ...
        console.error('❌ Error testing enrichment:', error.message);
        return null;
    }
}
